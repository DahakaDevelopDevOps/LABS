...
int main()
{
	...
	try
	{
		...
		if ((hMS = CreateFile(L"\\\\WORKGROUP\\mailslot\\BOX", GENERIC_WRITE, FILE_SHARE_READ | FILE_SHARE_WRITE, NULL, OPEN_EXISTING, NULL, NULL)) == INVALID_HANDLE_VALUE)
			throw SetErrorMail("CreateFile: ", GetLastError());

		char wbuf[50] = "Hello from Aleksei ";
		DWORD wms;
